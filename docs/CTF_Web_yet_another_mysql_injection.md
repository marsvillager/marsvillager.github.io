::: info
2021-第五届空间智能安全大赛-Web-yet_another_mysql_injection
:::
...
```shell
➜  sqlmap git:(master) python sqlmap.py -r 1.txt -p username --dbs

[10:31:21] [WARNING] heuristic (basic) test shows that POST parameter 'username' might not be injectable
