...
| Instance | $g, g^a, g^{a^2},$ …$, g^{a^{n-1}}, g^{af(a)}, g^{b \cdot af(a)} \in \mathbb{G}$<br>$h, h^a, h^{a^2},$ …$, h^{a^{2k}}, h^{b \cdot g(a)} \in \mathbb{G}$<br/> $Z \in \mathbb{G}_T$<br/>$f(x), g(x)$ are co-prime polynomials of degree $n, k$. |
